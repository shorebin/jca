// Decompiled by DJ v3.9.9.91 Copyright 2005 Atanas Neshkov  Date: 2016/7/9 10:10:52
...
public class Arrays2 {
	...
	private static int med3(String x[], int a, int b, int c) {
		return x[a].compareTo(x[b]) >= 0 ? x[b].compareTo(x[c]) <= 0 ? x[a].compareTo(x[c]) <= 0 ? a : c : b
				: x[b].compareTo(x[c]) >= 0 ? x[a].compareTo(x[c]) >= 0 ? a : c : b;
	}
